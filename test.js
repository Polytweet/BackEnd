...
const consumer_key = 'o81AQ2CsWyUu9SnGmVwut0Hhz'; // Add your API key here
const consumer_secret = 'XZnPaQJ7zPLeqJWKuucNT7VSdqa9yANeYtQi9LBpjQv3mwAdA8'; // Add your API secret key here
...
const endpointURL = new URL('https://api.twitter.com/1.1/search/tweets.json?q=from%3Atwitterdev&result_type=mixed&count=2');
// const endpointURL = new URL('https://api.twitter.com/1.1/search/tweets.json?q=from%3Atwitterdev&result_type=mixed&count=2'); 
